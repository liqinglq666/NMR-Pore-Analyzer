...
| Capillary pores | $[4.2,\ 41.7)$ | $[100,\ 993)$ |
| Air-voids | $[41.7,\ +\infty)$ | $[993,\ +\infty)$ |

### 5. 孔隙分类体系 B（损伤潜势）

| 类别 | $T_2$ (ms) | $r$ (nm) |
|---|---|---|
| Harmless | $[0,\ 8.3)$ | $[0,\ 198)$ |
| Less-harmful | $[8.3,\ 20.8)$ | $[198,\ 495)$ |
| Harmful | $[20.8,\ 83.3)$ | $[495,\ 1984)$ |
| More-harmful | $[83.3,\ +\infty)$ | $[1984,\ +\infty)$ |
